        ...
        case .title1(let weight):
            ...
            case .bold:
                return BKFontAttributes(
                    ...
                    fontSize: .pt28,
                    lineHeight: .p135_8,
                    letterSpacing: .pNegative2_36
                )
            case .semiBold:
                return BKFontAttributes(
                    fontName: .pretendardSemiBold,
                    fontSize: .pt28,
                    lineHeight: .p135_8,
                    letterSpacing: .pNegative2_36
                )
...
public struct BKFontAttributes {
    ...
    public init(
        fontName: BKFontName,
        fontSize: BKFontSize,
        lineHeight: BKLineHeight,
        letterSpacing: BKLetterSpacing?
    ) {
